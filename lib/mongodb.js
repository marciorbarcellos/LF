...
// Em ambientes serverless (Vercel), a resolução de DNS às vezes prioriza
// endereços IPv6 para o SRV do Atlas, e o handshake TLS por IPv6 falha
// nesse ambiente (aparece como "SSL alert number 80"). Forçar IPv4 evita isso.
